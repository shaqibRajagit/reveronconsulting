                ...
                <div id="main-clickable">
                    ...
                    <div class = 'main-container' id="clickable">
                        ...
                        <div class="container-content">
                            ...
                            <p class="para3" style="margin-left:20px">a) Tick the checkbox of user account that the admin wants to restore from the system.</p>
                            ...
                            <p class="para6" style="margin-left:40px">• Observe that there is a <b>Recover</b> button displayed upon ticking on the user account(s).</p>
                            <p class="para7">3.	Click <b>Recover</b> to recover selected user account.</p>
                            ...
                            <p class="para11" style="margin-left:40px">• Observe that the user(s) is then removed from the Inactive User List table and added back into the Active User List table.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Step_3d_Archive_User" class="previous">&#8678;</a>
                            <a href="Step_3f_Permanently_Delete_User" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
