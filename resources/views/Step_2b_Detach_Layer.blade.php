                ...
                <div id="main-clickable">
                    ...
                    <div class = 'main-container' id="clickable">
                        ...
                        <div class="container-content">
                            ...
                            <p class="para5">3.	Click the <kbd>DETACH</kbd> button to detach the layer data to current project.</p>
                            <p class="para6">4.	Click <b>OK</b>.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Step_2_Attach_Layer" class="previous">&#8678;</a>
                            <a href="Step_2c_Share_Data" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
            </div>
