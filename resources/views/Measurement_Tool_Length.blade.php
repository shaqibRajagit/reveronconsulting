                    ...
                    <div class = 'main-container' id="clickable">
                        <div class="breadcrumb-nav">
                            <ul class="breadcrumb">
                                ...
                                <li class="current">Length</li>
                            </ul>
                        </div>
                        <div class="container-header"><h3 class="headerText">Reveron Insights</h3></div>
                        <div class="container-content">
                            <h4>Length</h4>
                            <p class="para1">Length measure tool allow user to measure length between 2 point of interest.</p>
                            <p class="para2">1.	Navigate to the Length button.</p>
                            <p class="para3" style="margin-left:20px">a) Click the <b>Floating Action button</b> > <b>Measurement</b> > <b>Length</b>.</p>
                            ...
                            <p class="para6">3.	Click<img style="width: 25px; vertical-align: middle;"src="../Images/icons/instructions/dark_red/leftclick.png" alt="">on the second point of the measurement.</p>
                            <p class="para7">4.	Press <kbd>ESC</kbd> to exit the tool.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Measurement_Tool_Point" class="previous">&#8678;</a>
                            <a href="Measurement_Tool_Area" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
            </div>
