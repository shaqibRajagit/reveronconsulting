                ...
                <div id="main-clickable">
                    ...
                    <div class = 'main-container' id="clickable">
                        ...
                        <div class="container-content">
                            ...
                            <p class="para4">4.	Click the <kbd>REVISE</kbd> button.</p>
                            ...
                            <p class="para7">7.	Fill in available fields in the pop-up form.</p>
                            <p class="para8">8.	Once satisfied, click <kbd>SAVE</kbd> button to save the revised schedule.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Step_3_Add_Schedule" class="previous">&#8678;</a>
                            <a href="Config" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
            </div>
