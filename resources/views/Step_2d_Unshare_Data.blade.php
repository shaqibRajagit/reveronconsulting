                ...
                <div id="main-clickable">
                    ...
                    <div class = 'main-container' id="clickable">
                        ...
                        <div class="container-content">
                            ...
                            <p class="para5">3.	Click the <kbd>UNSHARE</kbd> button to unshare the layer data with another project.</p>
                            <p class="para6">4.	Click <b>OK</b>.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Step_2c_Share_Data" class="previous">&#8678;</a>
                            <a href="Step_2e_Delete_Data" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
            </div>
