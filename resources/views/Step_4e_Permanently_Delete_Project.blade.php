                    ...
                    <div class = 'main-container' id="clickable">
                        <div class="breadcrumb-nav">
                            <ul class="breadcrumb">
                                ...
                                <li class="current">Step 4e: Permanently Delete Project(s)</li>
                            </ul>
                        </div>
                        <div class="container-header"><h3 class="headerText">System Administration</h3></div>
                        <div class="container-content">
                            <h4>Step 4e: Permanently Delete Project(s)</h4>
                            ...
                            <p class="para2">2.	<b>Tick</b> checkbox of the project to be permanently delete.</p>
                            <p class="para3" style="margin-left:20px"><b>**Note:</b></p>
                            <p class="para4" style="margin-left:40px">• Observe that there is Recover and Delete button displayed upon ticking on the project.</p>
                            <p class="para5">3.	Click the <b>Delete</b> button to permanently delete ticked project.</p>
                            <p class="para6">4.	Click <b>Confirm</b> button to continue the process. Click <b>OK</b> to finish.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Step_4d_Recover_Project" class="previous">&#8678;</a>
                            <a href="Project_Administration_Overview" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
