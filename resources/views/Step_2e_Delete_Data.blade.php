                ...
                <div id="main-clickable">
                    ...
                    <div class = 'main-container' id="clickable">
                        ...
                        <div class="container-content">
                            ...
                            <p class="para5">3.	Click the <kbd>DELETE</kbd> button to delete the layer data with another project.</p>
                            <p class="para4" style="margin-left:20px"><b>**Note:</b></p>
                            <p class="para5" style="margin-left:40px">• Layer need to be detached from the project before admin can delete the layer.</p>
                            <p class="para6">4. Click <b>Confirm</b> to continue with the process.</p>
                            <p class="para7">5. Click <b>OK</b>.</p>
                        </div>
                        <div class="prevnext-button">
                            <a href="Step_2d_Unshare_Data" class="previous">&#8678;</a>
                            <a href="Step_2f_View_Projects" class="next">&#8680;</a>
                        </div>
                    </div>
                </div>
            </div>
